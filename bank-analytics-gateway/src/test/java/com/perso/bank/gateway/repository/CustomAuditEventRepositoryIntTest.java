package com.perso.bank.gateway.repository;

import com.perso.bank.gateway.BankAnalyticsGatewayApp;
import com.perso.bank.gateway.config.Constants;
import com.perso.bank.gateway.config.audit.AuditEventConverter;
import com.perso.bank.gateway.domain.PersistentAuditEvent;
...
import static com.perso.bank.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
