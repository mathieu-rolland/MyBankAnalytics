...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BankAnalyticsGateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BankAnalyticsGateway");
        ...
        config.getMapConfigs().put("com.perso.bank.gateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
