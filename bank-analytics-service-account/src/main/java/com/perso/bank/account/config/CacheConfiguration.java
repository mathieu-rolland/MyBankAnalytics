package com.perso.bank.account.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BankAnalyticsServiceAccount");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BankAnalyticsServiceAccount");
        ...
        config.getMapConfigs().put("com.perso.bank.account.domain.*", initializeDomainMapConfig(jHipsterProperties));
