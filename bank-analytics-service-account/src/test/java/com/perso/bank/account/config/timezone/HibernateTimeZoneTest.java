package com.perso.bank.account.config.timezone;

import com.perso.bank.account.BankAnalyticsServiceAccountApp;
import com.perso.bank.account.repository.timezone.DateTimeWrapper;
import com.perso.bank.account.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = BankAnalyticsServiceAccountApp.class)
