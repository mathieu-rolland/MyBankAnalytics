...
@Component({
    selector: 'jhi-operation-my-bank-analytics',
    templateUrl: './operation-my-bank-analytics.component.html'
})
export class OperationMyBankAnalyticsComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/operation-my-bank-analytics'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.router.navigate(['/operation-my-bank-analytics', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: OperationMyBankAnalytics) {
        return item.id;
    }
