...
@Component({
    selector: 'jhi-category-my-bank-analytics',
    templateUrl: './category-my-bank-analytics.component.html'
})
export class CategoryMyBankAnalyticsComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: CategoryMyBankAnalytics) {
        return item.id;
    }
