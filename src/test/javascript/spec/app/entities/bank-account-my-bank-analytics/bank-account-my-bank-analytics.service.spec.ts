...
describe('Service Tests', () => {
    ...
    describe('BankAccountMyBankAnalytics Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BankAccountMyBankAnalyticsService);
        ...
        describe('Service methods', () => {
            ...
            it('should return BankAccountMyBankAnalytics', () => {

                let entity: BankAccountMyBankAnalytics;
                service.find(123).subscribe((_entity: BankAccountMyBankAnalytics) => {
                    entity = _entity;
                });
