...
describe('Service Tests', () => {
    ...
    describe('ExtendedUserMyBankAnalytics Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ExtendedUserMyBankAnalyticsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/extended-users';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ExtendedUserMyBankAnalytics', () => {

                let entity: ExtendedUserMyBankAnalytics;
                service.find(123).subscribe((_entity: ExtendedUserMyBankAnalytics) => {
                    entity = _entity;
                });
