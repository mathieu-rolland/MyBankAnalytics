...
describe('Service Tests', () => {
    ...
    describe('OperationMyBankAnalytics Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OperationMyBankAnalyticsService);
        ...
        describe('Service methods', () => {
            ...
            it('should return OperationMyBankAnalytics', () => {

                let entity: OperationMyBankAnalytics;
                service.find(123).subscribe((_entity: OperationMyBankAnalytics) => {
                    entity = _entity;
                });
